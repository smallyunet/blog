...
我前几天无意中在 Medium 上看到一篇文章，作者用很简洁的代码写出了从私钥到地址的计算过程，作者的代码在这里 [RareSkills/generate-ethereum-address-lower-level.py](https://gist.github.com/RareSkills/eb51623908f348663cd6a241d9dbf115)。
